...
This code sample builds on the pipe_array tutorial. It uses the header file `pipe_utils.hpp` from DirectProgramming/DPC++FPGA/include, and provides the `compute_units.hpp` header as well.
